...
#ifndef _h_hkws_sdk_to_py_imp_
#define _h_hkws_sdk_to_py_imp_
#include <iostream>
#include <functional>
#include <vector>
#include <mutex>
...
{
public:
	typedef  std::function<void(int rc_type, int w, int h, std::string& yuv)> RC_HANDLE;
	enum  RC_TYPE
	{
		RC_NULL = 0,//什么都没有
		RC_DATA,//数据回调
	...
	public:
		...
		/*py::array_t<unsigned char>GetYuv() {
